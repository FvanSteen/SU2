...
void CConfig::SetPointersNull() {
  ...
  Marker_CfgFile_Deform_Mesh_IL_Wall   = nullptr;  Marker_All_Deform_Mesh_IL_Wall   = nullptr;
  ...
  Marker_Deform_Mesh_IL_Wall  = nullptr;    Marker_Deform_Mesh_Slide    = nullptr;
...
void CConfig::SetConfig_Options() {
 ...
 /* DESCRIPTION: default value for AIR */
  ...
  /*!\brief MARKER_DEFORM_MESH_IL_WALL\n DESCRIPTION: Inflation layer marker for mesh deformation only \ingroup Config*/
  addStringListOption("MARKER_DEFORM_MESH_IL_WALL", nMarker_Deform_Mesh_IL_Wall, Marker_Deform_Mesh_IL_Wall);
    
  addStringListOption("MARKER_DEFORM_MESH_SLIDE", nMarker_Deform_Mesh_Slide, Marker_Deform_Mesh_Slide); //TODO
...
void CConfig::SetMarkers(SU2_COMPONENT val_software) {
  ...
  iMarker_Fluid_Load, iMarker_Deform_Mesh, iMarker_Deform_Mesh_Sym_Plane, iMarker_Deform_Mesh_Internal, iMarker_Deform_Mesh_IL_Wall, iMarker_Deform_Mesh_Slide,
  ...
  Marker_All_Deform_Mesh_IL_Wall = new unsigned short[nMarker_All] (); //Store wheter the boundary will have an inflation layer.
  Marker_All_Deform_Mesh_Slide = new unsigned short[nMarker_All] (); //Store wheter the boundary will have an inflation layer. //TODO
  ...
  Marker_CfgFile_Deform_Mesh_IL_Wall  = new unsigned short[nMarker_CfgFile] ();
  ...
  for (iMarker_CfgFile = 0; iMarker_CfgFile < nMarker_CfgFile; iMarker_CfgFile++) {
    Marker_CfgFile_Deform_Mesh_IL_Wall[iMarker_CfgFile] = NO;
    for (iMarker_Deform_Mesh_IL_Wall = 0; iMarker_Deform_Mesh_IL_Wall < nMarker_Deform_Mesh_IL_Wall; iMarker_Deform_Mesh_IL_Wall++)
      if (Marker_CfgFile_TagBound[iMarker_CfgFile] == Marker_Deform_Mesh_IL_Wall[iMarker_Deform_Mesh_IL_Wall])
        Marker_CfgFile_Deform_Mesh_IL_Wall[iMarker_CfgFile] = YES;
  }
...
void CConfig::SetOutput(SU2_COMPONENT val_software, unsigned short val_izone) {
  ...
  iMarker_Deform_Mesh, iMarker_Deform_Mesh_Sym_Plane, iMarker_Deform_Mesh_Internal, iMarker_Deform_Mesh_IL_Wall, iMarker_Deform_Mesh_Slide,
  ...
  if (nMarker_Deform_Mesh_IL_Wall!= 0) {
    BoundaryTable << "Inflation layer mesh boundary";
    for (iMarker_Deform_Mesh_IL_Wall = 0; iMarker_Deform_Mesh_IL_Wall < nMarker_Deform_Mesh_IL_Wall; iMarker_Deform_Mesh_IL_Wall++) {
      BoundaryTable << Marker_Deform_Mesh_IL_Wall[iMarker_Deform_Mesh_IL_Wall];
      if (iMarker_Deform_Mesh_IL_Wall < nMarker_Deform_Mesh_IL_Wall-1)  BoundaryTable << " ";
    }
    BoundaryTable.PrintFooter();
  }
...
unsigned short CConfig::GetMarker_CfgFile_Deform_Mesh_IL_Wall(const string& val_marker) const {
  unsigned short iMarker_CfgFile;
  for (iMarker_CfgFile = 0; iMarker_CfgFile < nMarker_CfgFile; iMarker_CfgFile++)
    if (Marker_CfgFile_TagBound[iMarker_CfgFile] == val_marker) break;
  return Marker_CfgFile_Deform_Mesh_IL_Wall[iMarker_CfgFile];
}
...
CConfig::~CConfig() {
  ...
  delete[] Marker_CfgFile_Deform_Mesh_IL_Wall;
  delete[] Marker_All_Deform_Mesh_IL_Wall;
...
unsigned short CConfig::GetMarker_Deform_Mesh_IL_Wall(const string& val_marker) const {
  unsigned short iMarker;

  /*--- Find the marker for this inflation layer boundary. ---*/
  for (iMarker = 0; iMarker < nMarker_Deform_Mesh_IL_Wall; iMarker++)
    if (Marker_Deform_Mesh_IL_Wall[iMarker] == val_marker) break;
  return iMarker;
}
...
unsigned short CConfig::GetMarker_Deform_Mesh_Slide(const string& val_marker) const {
  ...
  /*--- Find the marker for this inflation layer boundary. ---*/ //TODO
